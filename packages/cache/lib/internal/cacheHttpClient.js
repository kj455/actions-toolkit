...
function downloadCache(archiveLocation, archivePath, options, cacheKey, s3Options, s3BucketName) {
    return __awaiter(this, void 0, void 0, function* () {
        const archiveUrl = new url_1.URL(archiveLocation);
        const downloadOptions = (0, options_1.getDownloadOptions)(options);
        console.log({ s3Options, s3BucketName });
        ...
        if (s3Options && s3BucketName && cacheKey) {
            yield (0, downloadUtils_1.downloadCacheStorageS3)(cacheKey, archivePath, s3Options, s3BucketName);
        }
        else {
